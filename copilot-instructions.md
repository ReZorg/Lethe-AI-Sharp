...
- `Memory/`: The various memory systems used by the library and personas
- `Personas/`: The persona system allowing for customizable AI characters (and groups) with complex behaviors
...
## Key Guidelines
1. Follow C# best practices and idiomatic patterns in .NET 10
